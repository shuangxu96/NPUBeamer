# NPUBeamer 西北工业大学学术答辩 LaTeX-Beamer 模板

**简洁美观 | 开源字体无版权风险 | 西工大专属蓝调主题 | 学术答辩专用 | XeLaTeX 编译**

✨ 本模板为**西北工业大学专属学术答辩 Beamer 模板**，适配本科、硕士、博士学位答辩、课程汇报、学术会议宣讲。模板采用西工大专属蓝色主色调，排版规整、样式精致，全程使用开源字体，规避系统自带字体的商用版权问题，支持自由开源、二次修改与个人/商用使用。

模板基于 XeLaTeX 编译，完美兼容中文排版，内置全套定理、定义、算法、代码、图表学术环境，注释详尽、开箱即用，无需复杂配置。

## 📌 项目简介

本模板由西北工业大学数学与统计学院学生开发，针对高校学术汇报场景深度定制，解决原生 Beamer 中文乱码、样式简陋、排版不规范、商用字体版权受限等痛点。

**核心特性**

* **零版权风险**：全部使用开源字体，摒弃 SimSun、SimKai、微软雅黑等商用受限系统字体
* **专属校园主题**：定制 NPU 蓝、深蓝专属配色，风格庄重学术，贴合西工大答辩视觉规范
* **完整学术环境**：内置定理、引理、推论、定义、例题、习题、注记、算法、代码高亮全套学术模块
...
涵盖封面页、双栏目录页、章节过渡页、字体展示页、文本排版、列表环境、定理区块、公式环境、图表表格、代码算法、参考文献等全套答辩常用页面。
...
将编辑器编译模式设置为 **XeLaTeX**，直接编译 `main.tex`，即可生成完整答辩 PDF。
...
* **答辩专用宽屏**：定制适配大屏投影的宽屏尺寸，自适应会场显示设备
...
欢迎 Star、Fork、提交 Issue，欢迎全网开发者、西工大在校同学共建优化模板，适配更多专业场景、修复问题、新增功能均可提交 PR。
